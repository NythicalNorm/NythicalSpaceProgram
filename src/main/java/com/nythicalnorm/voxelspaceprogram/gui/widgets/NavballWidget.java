...
public class NavballWidget extends AbstractWidget {
    private static final ResourceLocation NAVBALL_GUI_TEXTURE = VoxelSpaceProgram.rl(
            "textures/gui/navballwidget.png");

    private static final ResourceLocation NAVBALL_TEXTURE = VoxelSpaceProgram.rl(
